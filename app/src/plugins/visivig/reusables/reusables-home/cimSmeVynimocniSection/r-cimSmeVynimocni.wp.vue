  ...
  <div id="cim-sme-vynimocni-center" class="blue-div mb-70">
    <div class="pdtb-80 container">
      ...
      <div class="pdtb-10 row">
        <div class="col-md">
          <div class="pb-15">
            <img
              class="lab-img"
              src="/wp-content/themes/wp-bootstrap-starter/assets/images/5ea164d2a80fd5ea09fed5409d1.png"
            />
        ...
        <div class="col-md">
          <div class="pb-15">
            <img class="lab-img" src="/wp-content/themes/wp-bootstrap-starter/assets/images/2.png" />
        ...
        <div class="col-md">
          <div class="pb-15">
            <img class="lab-img" src="/wp-content/themes/wp-bootstrap-starter/assets/images/3.png" />
      ...
      <div id="iv8aq" class="pdtb-10 row">
        <div class="col-md">
          <div class="pb-15">
            <img class="lab-img" src="/wp-content/themes/wp-bootstrap-starter/assets/images/4.png" />
        ...
        <div class="col-md">
          <div class="pb-15">
            <img class="lab-img" src="/wp-content/themes/wp-bootstrap-starter/assets/images/5.png" />
        ...
        <div class="col-md">
          <div class="pb-15">
            <img class="lab-img" src="/wp-content/themes/wp-bootstrap-starter/assets/images/6.png" />
