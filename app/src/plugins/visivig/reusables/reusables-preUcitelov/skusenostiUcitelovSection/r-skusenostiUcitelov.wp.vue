  ...
  <div id="skusenosti" class="container">
    ...
    <div id="skus-ucitel-flex" class="row">
      <div class="col col-md-6 col-sm-12">
        <img class="skusImg" src="/wp-content/themes/wp-bootstrap-starter/assets/images//5f8339d487632PR.jpeg" />
        <h2 class="hlc">
        ...
        <p id="skusenosti-1" class="hlc">
          ...
          Vašej škole, rozhodno odporúčam zúčastniť sa aspoň online školení,
          ktoré získate výborné materiály pre nové technológie, ktoré budú baviť
          študentov aj Vás!"
        </p>
      </div>
      <div class="col col-md-6 col-sm-12">
        <img class="skusImg" src="/wp-content/themes/wp-bootstrap-starter/assets/images//lenka-obraozk.png" />
        <h2 class="hlc">
        ...
        <p id="skusenosti-2" class="hlc">
          ...
          samoštúdiom. Mne osobne drilleo.sk pomáha, využívam ho ako doplnkový
          nástroj a overujem si znalosti študentov. Rovnako sa mi páči, že
          vidím, kto je na akej otázke, kto kedy začína a končí, takže už počas
          písomky si zapisujem priebežné výsledky."
        </p>
      </div>
    </div>
    <hr />
